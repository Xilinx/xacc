...
<table width="100%">
    ...
    <tr>
        ...
        <td>UCLA</td>
        <td><a href="https://doi.org/10.1145/3490422.3502361">Paper</a> <img src="./images/best_paper_award.png" alt="Best Paper" height="100"></td>
...
<table width="100%">
    ...
    <tr>
        <td>AutoBridge: Coupling Coarse-Grained Floorplanning and Pipelining for High-Frequency HLS Design on Multi-Die FPGAs</td>
        <td>Licheng Guo <em>et al.</em></td>
        <td>UCLA</td>
